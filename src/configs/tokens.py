...
_ETH_MAINNET_TOKENS['BTC'] = _ETH_MAINNET_TOKENS['WBTC']
...
_ARBITRUM_TOKENS: dict[str, Token] = {
    ...
    'CHIP':   Token(Address('0x0c1C1C109fE34733FCa54B82D7B46b75CFB71F6E'), 'CHIP', 18),
}
_ARBITRUM_TOKENS['ETH'] = _ARBITRUM_TOKENS['WETH']
_ARBITRUM_TOKENS['BTC'] = _ARBITRUM_TOKENS['WBTC']

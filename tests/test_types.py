...
from core.types import Address, TokenAmount, Token
...
def test_address_case_insensitive():
    assert Address("0xab5801a7d398351b8be11c439e05c5b3259aec9b") == \
...
def test_token_different_address_not_equal():
    t1 = Token(address=Address("0xab5801a7d398351b8be11c439e05c5b3259aec9b"), symbol="A", decimals=18)
    t2 = Token(address=Address("0xdac17f958d2ee523a2206206994597c13d831ec7"), symbol="A", decimals=18)
    assert t1 != t2
